...
const Cell = ({
  ...
  setClickedCell: React.Dispatch<React.SetStateAction<CellPosition>>;
}) => {
...
const Pattern = ({
  ...
  const [clickedCell, setClickedCell] = useState<CellPosition>(null);
